...
e py-16 px-6 md:px-12 lg:px-20 overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto text-center relative z-10">
                ...
                <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-3xl mx-auto mb-8">
                    Inanst is a forward-thinking tech platform dedicated to raising and building careers, nurturing professionals, and bridging the gap between school life and skill life. We empower students, workers, and tech enthusiasts by offering real-world projects, expert mentorship, and a strong community.
                </p>
