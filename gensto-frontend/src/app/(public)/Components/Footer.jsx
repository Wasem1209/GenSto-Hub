        ...
        <div className='flex flex-col items-center-start'>
          ...
          <div className="flex justify-center  space-x-4">
            <div className="flex space-x-4 hover:scale-110 transition-transform">
              <SocialIcon url="https://www.facebook.com/share/1CpdcD5o1q/" target="_blank" rel="noopener noreferrer" style={{ height: 30, width: 30 }} />
            </div>
            <div className="flex space-x-4 hover:scale-110 transition-transform">
              <SocialIcon url="https://x.com/INANST541343" target="_blank" rel="noopener noreferrer" style={{ height: 30, width: 30 }} />
            </div>
            <div className="flex space-x-4 hover:scale-110 transition-transform">
