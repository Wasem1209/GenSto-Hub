    ...
    return(
        <section className="relative bg-white py-16 px-6 md:px-12 lg:px-20 overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto text-center relative z-10">
                ...
                <button className="bg-gray-700 hover:bg-gray-700 text-white font-semibold px-6 py-3 rounded-full transition-all duration-300 shadow-md">Course Overview →</button></Link>
            </div>
        </section>
    )
}