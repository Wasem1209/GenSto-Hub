    ...
    <header className="w-full bg-white flex items-center justify-between shadow-md fixed top-0 left-0 z-50">
      ...
      <div className="flex items-center space-x-3 ml-2 sm:ml-4 md:ml-6">
        ...
        <div className="ml-[-25px]">
          <h1 className="text-xl font-semibold text-gray-800 px-6 pr-30">INANST</h1>
          <p className="text-xs text-gray-500 pl-6 mb-2">Innovation, Analytics And Societal Transformation</p>
        </div>
      </div>
