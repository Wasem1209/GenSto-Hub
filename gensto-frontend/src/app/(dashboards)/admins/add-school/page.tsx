...
export default function AddSchoolPage() {
  ...
  return (
    <section className="min-h-screen bg-gray-50 pt-24 pb-16 px-4 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-sm border border-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[#1a1f2e] font-black text-sm uppercase tracking-wider">Price (Formatted)</label>
              <input 
                type="text"
                required
                placeholder="₦45,000"
            ...
            {/* Icon Selection with Visual Previews */}
